...
class BallMarker(object):
    ...
    def __init__(self, color, alpha=1.0, scale=0.05):
        """
        The color can be specified as a list with 3 elements or as the
        color dictionary (e.g. BLUE, RED, etc). Alpha sets the
    ...
    def position(self, T):
        """
        Set position (4x4 NumPy homogeneous matrix) for the ball and
        publish it
